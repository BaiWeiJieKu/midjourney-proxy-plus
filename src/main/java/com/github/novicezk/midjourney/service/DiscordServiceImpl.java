...
public class DiscordServiceImpl implements DiscordService {
	...
	public Message<Void> upscaleX(String messageId, int num, String messageHash, int messageFlags, String nonce){
		String paramsStr = replaceInteractionParams(this.paramsMap.get("upsample"+num+"x"), nonce)
				.replace("$message_id", messageId)
				.replace("$message_hash", messageHash);
		paramsStr = new JSONObject(paramsStr).put("message_flags", messageFlags).toString();
		return postJsonAndCheckStatus(paramsStr);
	...
	public Message<Void> outpaintX(String messageId, int num, String messageHash, int messageFlags, String nonce){
		String paramsStr = replaceInteractionParams(this.paramsMap.get("outpaint"+num+"x"), nonce)
				.replace("$message_id", messageId)
				.replace("$message_hash", messageHash);
		paramsStr = new JSONObject(paramsStr).put("message_flags", messageFlags).toString();
		return postJsonAndCheckStatus(paramsStr);
	...
	public Message<Void> variationLow(String messageId, String messageHash, int messageFlags, String nonce) {
		String paramsStr = replaceInteractionParams(this.paramsMap.get("variationlow"), nonce)
				.replace("$message_id", messageId)
				.replace("$message_hash", messageHash);
		paramsStr = new JSONObject(paramsStr).put("message_flags", messageFlags).toString();
		return postJsonAndCheckStatus(paramsStr);
	...
	public Message<Void> variationHigh(String messageId, String messageHash, int messageFlags, String nonce) {
		String paramsStr = replaceInteractionParams(this.paramsMap.get("variationhigh"), nonce)
				.replace("$message_id", messageId)
				.replace("$message_hash", messageHash);
		paramsStr = new JSONObject(paramsStr).put("message_flags", messageFlags).toString();
		return postJsonAndCheckStatus(paramsStr);
	...
	public Message<Void> direction(String direction,String messageId, String messageHash, int messageFlags, String nonce){
		String paramsStr = replaceInteractionParams(this.paramsMap.get("direction"), nonce)
				.replace("$message_id", messageId)
	...
	private ResponseEntity<String> postJson(String url, String paramsStr) {
		...
		log.info("url:{},entity:{},param:{}",url,httpEntity,paramsStr);
